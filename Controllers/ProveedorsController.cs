...
namespace Semana5.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre")] Proveedor proveedor)
        {
